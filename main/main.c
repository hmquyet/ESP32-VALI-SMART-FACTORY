...
#define GPIO_INPUT_CYCLE_1 36 // 36
...
void app_main()
{
  ...
  // Set up gpio input
  button_events = button_init(PIN_BIT(GPIO_INPUT_CYCLE_1) |
  ...
  soft_timer_handle_7 = xTimerCreate(BOOT_CONNECT_TIMER, pdMS_TO_TICKS(3600), false, (void *)7, &vSoftTimerCallback); // Timer Reboot to connect
  xTimerStart(soft_timer_handle_5, 10);
